...
public class AutoGeneratedUserFunctionDocumentationTest extends BaseDocumentationTest {
    ...
    public void testFunctionBody() throws Exception {
        var expectedDocumentation = "function <b>toString</b><br>Arguments:<br>&nbsp;&nbsp;&nbsp;&nbsp;(input :: ANY)<br>Return:<br>&nbsp;&nbsp;&nbsp;&nbsp;STRING<br><br>Converts an `INTEGER`, `FLOAT`, `BOOLEAN`, `POINT` or temporal type (i.e. `DATE`, `ZONED TIME`, `LOCAL TIME`, `ZONED DATETIME`, `LOCAL DATETIME` or `DURATION`) value to a `STRING`.";
